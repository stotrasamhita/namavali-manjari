...
| Source | Output | Notes |
|---|---|---|
| `nAmA.tex` | `nAmA.pdf` | Default digital edition (A5, twoside). |
| `nAmA-print.tex` | `nAmA-print.pdf` | Same A5 page, with wider gutter margins for physical binding. |
| `nAmA-kindle.tex` | `nAmA-kindle.pdf` | Kindle paperback size (126×168mm). |
| `nAmA-kindle-scribe.tex` | `nAmA-kindle-scribe.pdf` | Larger page (140×185mm) for the Kindle Scribe's screen. |
