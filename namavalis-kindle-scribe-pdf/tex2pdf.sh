...
cat nama-kindle-template.tex | sed "s@FPATH@$fpath@;s@SSURL@$SSURL@" > 100/$jobname.tex
...
cat nama-kindle-template.tex | sed "s@FPATH@$fpath@;s@SSURL@$SSURL@" > 1000/$jobname.tex
...
cat nama-kindle-template.tex | sed "s@FPATH@$fpath@;s@SSURL@$SSURL@" > 300/$jobname.tex
